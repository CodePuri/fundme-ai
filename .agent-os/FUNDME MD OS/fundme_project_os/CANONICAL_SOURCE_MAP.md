...
5. Approved Yasha/Figma handoff recorded in [DESIGN_SOURCE_OF_TRUTH.md](./DESIGN_SOURCE_OF_TRUTH.md)
...
| [DESIGN_SOURCE_OF_TRUTH.md](./DESIGN_SOURCE_OF_TRUTH.md) | Approved design links, frames, tokens, palette, responsive and edge states | Every approved design milestone |
...
- [PHASE_1A_DESIGN_ACCEPTANCE.md](./PHASE_1A_DESIGN_ACCEPTANCE.md)
...
- [supporting/V1_EXPERIENCE_CONTRACT.md](./supporting/V1_EXPERIENCE_CONTRACT.md) — interaction and report hierarchy; subordinate to product truth, approved Figma, and active phase scope.
...
Product documents control the user, problem, feature scope, evidence/scoring rules, privacy, security, and release sequence. Approved Figma controls customer-facing layout, hierarchy, components, interactions, responsive behavior, and visual language. Code controls implemented behavior.

The Sera HTML is interaction reference only. Existing Production UI is preserved unless an approved design decision explicitly retains or changes it.
